...
.controller('PaginationController', ['$scope', '$attrs', '$parse',
  ...
  this.calculateTotalPages = function() {
    var totalPages = this.itemsPerPage < 1 ? 1 : Math.ceil($scope.totalItems /
      this.itemsPerPage);
  ...
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      var maxSize = angular.isDefined(attrs.maxSize) ?
        scope.$parent.$eval(attrs.maxSize) : paginationConfig.maxSize,
        rotate = angular.isDefined(attrs.rotate) ?
          scope.$parent.$eval(attrs.rotate) : paginationConfig.rotate;
  ...
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      scope.align = angular.isDefined(attrs.align) ?
        scope.$parent.$eval(attrs.align) : pagerConfig.align;
