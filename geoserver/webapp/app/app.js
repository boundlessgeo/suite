    ...
    function($scope, $state, AppEvent, AppSession, $window, $timeout,
      ...
      $scope.sessionTracker = function(){
        if($location.path() != '/login') {
          ...
          //$rootScope.sessionWarning = (AppSession.timeout * 1000) - 120000;
          //$rootScope.sessionTimeout = AppSession.timeout * 1000;
          //session timeout isn't coming back just yet.
          $rootScope.sessionWarning = (1800 * 1000) - 120000;
          $rootScope.sessionTimeout = 1800 * 1000;
